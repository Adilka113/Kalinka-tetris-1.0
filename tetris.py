...
pygame.mixer.music.load('kalinka.mp3')
...
game_bg = pygame.transform.scale(pygame.image.load('image-20.png').convert(), (W * TILE, H * TILE))
bg = pygame.transform.scale(pygame.image.load('spi.png').convert(), (RES))
